...
\documentclass[ecta,nameyear,draft]{/workspaces/econ-project/tex/paper/econsocart}
%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\address[id=add1]{%
\orgdiv{University of Tokyo}%,
\orgname{Graduate School of Economics}}
\end{aug}

\support{Graduate School of Economics, The University of Tokyo}
...
\bibliography{/workspaces/econ-project/tex/paper/bibliography.bib}  % Bibliography file (usually '*.bib')
